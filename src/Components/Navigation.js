...
<div class="absolute bg-white dark:bg-gray-800 shadow-lg">
    <div class="flex flex-col sm:flex-row sm:justify-around sticky">
	    ...
	    <Avatar name="Wim Mostmans" size="50" round/>
            ...
            <nav class="mt-10 px-6 ">
                <Link to="#" class="hover:text-white hover:bg-indigo-600 flex items-center p-2 my-6 transition-colors duration-200  text-gray-600 rounded-lg  bg-gray-100" href="#">
                ...
                <Link to="#" class="hover:text-white hover:bg-indigo-600 flex items-center p-2 my-6 transition-colors  duration-200  text-gray-800  rounded-lg" href="#">
                    <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link to='#' class="hover:text-white hover:bg-indigo-600 flex items-center p-2 my-6 transition-colors dark:hover:text-white duration-2  rounded-lg " href="#">
                    <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link to="#" class="hover:text-white hover:bg-indigo-600 flex items-center p-2 my-6 transition-colors duration-200  text-gray-600 rounded-lg " href="#">
            ...
            <div class="absolute bottom-10 my-10">
                <Link to="#" class="hover:text-white hover:bg-indigo-600 transition-colors duration-200 flex items-center py-2 px-8" href="#">
